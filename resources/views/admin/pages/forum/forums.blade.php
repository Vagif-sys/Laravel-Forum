                    ...
                    <tbody>
                        @if (count($forums)> 0)
                            ...
                            <tr>
                                ...
                                <td>{!!$forum->desc!!}</td>
                                <td><a href="{{route('forum.single',$forum->id)}}"><i class="fa fa-eye text-success"></i></a></td>
                                <td><a href="{{route('forum.edit',$forum->id)}}"><i class="fa fa-edit text-info"></i></a></td>
                                <td><a href="{{route('forum.delete',$forum->id)}}" class="text-danger"><i class="fa fa-trash"></i>Delete</a></td>
