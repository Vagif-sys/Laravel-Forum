...
<div class="container">
          ...
          <table class="table table-striped table-responsivelg table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <h3 class="h6">
                    <span class="badge badge-primary">{{count($topic->replies)}} replies</span>
                    <a href="{{route('topic',$topic->id)}}" class="">{{$topic->title}}</a>
                  </h3>
                {{--   <div class="small">
                    Go to page: <a href="#">1</a>, <a href="#">2</a>,
                    <a href="#">3</a>, <a href="#">4</a> &hellip;<a href="#">9</a>,<a href="#">10</a>
                  </div> --}}
                </td>
                <td>
              ...
              <div class="text-center">No topics found in this Forum</div>
                @endif
  ...
  <div class="mb-3 clearfix">
    ...
    <form action="" class="form-inline float-lg-left d-block d-sm-flex" method="POST">
