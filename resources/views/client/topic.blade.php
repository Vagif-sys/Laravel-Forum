...
<div class="container-fluid">
  <div class="container">
    <nav class="breadcrumb">
      ...
      <a href="{{route('client.category',$topic->forum->category->id)}}" class="breadcrumb-item">{{$topic->forum->category->title}}</a>
              ...
              <tbody>
                ...
                <tr>
                  <td>
                    ...
                    <div>
                      <span class="font-weight-bold">Discussions:</span> {{count($topic->user->discussions)}}
                    </div>
                  </td>
                  <td>
                    <p>
              ...
              <tbody>
                <tr>
                  ...
                  <td class="post-col d-lg-flex justify-content-lg-between">
                    ...
                    @else
                      <div>
                        <a href='{{route('reply.like',$reply->id)}}'><i class="fa fa-thumbs-up text-success"></i>20</a>
                        <a href='{{route('reply.dislike',$reply->id)}}'><i class="fa fa-thumbs-down text-danger"></i>12</a>
                    </div>
                    @endif
                  </td>
                </tr>
    ...
    <div>
      <div class="d-lg-flex align-items-center mb-3">
        <form action="" class="form-inline d-block d-sm-flex mr-2 mb-3 mb-lg-0">
